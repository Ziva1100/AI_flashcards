    ...
    const saveFlashcards = async () => {
        ...
        if(docSnap.exist()){
            ...
            if (collection.find(f=> f.name === name)){
                ...
                batch.set(userDoc, {flashcards:collections}, {merge: true})}
        }
        else{
...
<Dialog open={open} onClose={handeClose}>
    <DialogTitle>Safe Flashcards</DialogTitle>
    <DialogContent>
        ...
        fullWidth value={name} onChange={(e)=>{
